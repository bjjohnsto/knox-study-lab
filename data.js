...
const STUDY_ITEMS = [
  ...
  /* ------------------------------------------------------------------ */
  {
    id: "hist-mesopotamia-lesson21",
    subject: "history",
    title: "Mesopotamia Lesson 21 \u2014 Achievements",
    added: "2026-09-02",
    quiz:  "2026-09-04",
    note:  "Heritage Studies Lesson 21, pages 36\u201339. Her study guide matches these to definitions.",
    type:  "vocab",
    words: [
      { word: "astrology",
      ...
      { word: "astronomy",
        meaning: "The scientific study of the stars and heavenly objects." },
      { word: "60-minute hour",
      ...
      { word: "wheel",
        meaning: "Improved transportation by land." }
    ],
    extras: [
  ...
  /* ------------------------------------------------------------------ */
  {
    id: "hist-ancient-world-vocab",
    subject: "history",
    title: "World History Vocab \u2014 Ancient World",
    added: "2026-09-03",
    quiz:  "2026-09-04",
    note:  "The matching worksheet. Goes past Mesopotamia into Babylon and the ancient world.",
    type:  "vocab",
    words: [
      { word: "Cuneiform",
        meaning: "The world's first known system of writing, developed by the Sumerians using wedge-shaped marks on clay tablets." },
      { word: "Astronomy",
        meaning: "The study of stars, planets, and other objects in space." },
      { word: "Astrology",
        meaning: "The belief that the positions of stars and planets can influence people's lives and events on Earth." },
      { word: "Epic",
        meaning: "A long poem or story about the adventures of a hero or important person." },
      { word: "Phalanx",
      ...
      { word: "Sargon I",
        meaning: "A powerful Akkadian ruler who conquered many Sumerian city-states and created one of the world's first empires." },
      { word: "Babylon",
        meaning: "An important ancient city in Mesopotamia that became the center of the Babylonian Empire." },
      { word: "Hammurabi",
        meaning: "A Babylonian king famous for creating a written collection of laws known as Hammurabi's Code." },
      { word: "Nebuchadnezzar II",
        meaning: "A powerful Babylonian king who rebuilt Babylon and is associated with the city's famous Ishtar Gate and Hanging Gardens tradition." }
    ]
  },

  /* ------------------------------------------------------------------ */
  {
    id: "hist-mesopotamia-practice",
    subject: "history",
    title: "Mesopotamia Practice Test",
    added: "2026-09-03",
    quiz:  "2026-09-04",
    note:  "Pages 30\u201339. True/false and multiple choice, straight from the textbook.",
    type:  "questions",
    questions: [
      /* --- true or false --- */
      { kind: "tf", prompt: "Sumerian schools were called tablet houses and were attached to the temple.",
        answer: true, why: "Students were usually boys from wealthy families, training to become scribes." },
      { kind: "tf", prompt: "Only men were ever allowed to learn to read and write in Mesopotamia.",
        answer: false, why: "Women born of royalty were allowed to learn to read and write. Some held administrative positions, conducted business, and owned property." },
      { kind: "tf", prompt: "Mesopotamian religion rejected the one true God and practiced polytheism.",
        answer: true, why: "They worshiped thousands of gods." },
      { kind: "tf", prompt: "The temple was the center of religion but had nothing to do with government.",
        answer: false, why: "The temple was both the center of religion and the seat of the Sumerian government." },
      { kind: "tf", prompt: "Each Sumerian king served as the chief lawmaker and judge.",
        answer: true, why: "He also directed the building of new canals, temples, and roads." },
      { kind: "tf", prompt: "Astrology is the scientific study of stars and heavenly bodies.",
        answer: false, why: "That is astronomy. Astrology is interpreting human events by the position of the stars \u2014 and the stars do not determine what happens. God does." },
      { kind: "tf", prompt: "The Mesopotamians divided the year into four seasons.",
        answer: false, why: "Two seasons: summer and winter. Their twelve-month calendar came from the cycles of the moon." },
      { kind: "tf", prompt: "Cuneiform comes from the Latin words for \"wedge-shaped.\"",
        answer: true, why: "Early writing used picture symbols, which were gradually replaced by wedge-shaped characters." },
      { kind: "tf", prompt: "A cylinder seal was rolled across a clay tablet and its envelope for security.",
        answer: true, why: "It meant the information inside could not be changed. The dried tablet was then stored in the temple." },
      { kind: "tf", prompt: "The Sumerians were the first people to recognize the concept of zero.",
        answer: true, why: "They were also first to give a number a place value." },

      /* --- multiple choice --- */
      { kind: "mc", prompt: "The temple that stood in the center of Ur was called a ___.",
        options: ["ziggurat", "phalanx", "cylinder seal", "tablet house"],
        answer: "ziggurat",
        why: "It was originally built by a king named Ur-Nammu, to honor the moon god." },
      { kind: "mc", prompt: "The moon god worshiped at Ur was named ___.",
        options: ["Nanna", "Enlil", "Inanna", "Marduk"],
        answer: "Nanna",
        why: "Ur-Nammu built the ziggurat at Ur to honor him." },
      { kind: "mc", prompt: "The Mesopotamian number system was based on the number ___.",
        options: ["60", "10", "12", "100"],
        answer: "60",
        why: "That is where our 60-minute hour, 60-second minute, and 360-degree circle come from." },
      { kind: "mc", prompt: "Sumerians made their clothing from wool or ___.",
        options: ["flax", "cotton", "silk", "leather"],
        answer: "flax",
        why: "Men wore skirt-like garments or robes. Both men and women wore jewelry \u2014 bracelets, necklaces, and earrings." },
      { kind: "mc", prompt: "People were taught that only ___ could intercede directly with the gods.",
        options: ["priests", "kings", "scribes", "soldiers"],
        answer: "priests",
        why: "That belief is what made priests so powerful in Mesopotamia." },
      { kind: "mc", prompt: "At first, who chose a military leader to defend the city-state?",
        options: ["the priest", "the king", "the scribes", "the people"],
        answer: "the priest",
      ...
      { kind: "mc", prompt: "Sumerians believed that a ___ selected the king.",
        options: ["god", "priest", "council", "army"],
        answer: "god",
        why: "The priest then acknowledged the king as the god's choice to rule the city-state." },
      { kind: "mc", prompt: "In Ur, a lawbreaker often had to pay ___ as punishment.",
        options: ["fines", "taxes", "labor", "livestock"],
        answer: "fines",
        why: "If a man cut off another man's foot or nose, he paid the injured man a certain amount of silver." },
      { kind: "mc", prompt: "Archaeologists often identify an ancient building by reading its ___.",
        options: ["stamped bricks", "cylinder seals", "clay envelopes", "wall paintings"],
      ...
      { kind: "mc", prompt: "Which of these did the Sumerians NOT develop?",
        options: ["the compass", "the plow", "the potter's wheel", "the sail"],
        answer: "the compass",
        why: "Their advances included the plow, the wheel, irrigation, the potter's wheel, and the sail." },
      { kind: "mc", prompt: "The Sumerian word for barley was ___, and its symbol could stand for that sound in any word.",
        options: ["she", "er", "ku", "ur"],
        answer: "she",
        why: "In she-er-ku, the word for fig cake, the barley symbol represented the first syllable." },
      { kind: "mc", prompt: "Besides Sumerian, cuneiform was used to write Akkadian, Hittite, and ___.",
        options: ["Urartian", "Egyptian", "Hebrew", "Greek"],
        answer: "Urartian",
        why: "Different peoples all used the cuneiform script to record information." },
      { kind: "mc", prompt: "Mesopotamian advances in medicine included making a list of symptoms with ___.",
        options: ["a diagnosis for each", "a prayer for each", "a fine for each", "a god for each"],
        answer: "a diagnosis for each",
        why: "One of several sciences they studied, alongside astronomy and mathematics." },
      { kind: "mc", prompt: "Legal records were required for business transactions, contracts, marriages, adoptions, and ___.",
        options: ["wills", "festivals", "harvests", "battles"],
        answer: "wills",
        why: "Archaeologists have found many of Sumer's records still in their clay envelopes, filed in the temples." },

      /* --- mark all that apply --- */
      { kind: "multi", prompt: "Which of these were Sumerian advances or inventions?",
        options: ["The plow", "The wheel", "Irrigation", "The potter's wheel", "The sail", "Gunpowder"],
        answers: ["The plow", "The wheel", "Irrigation", "The potter's wheel", "The sail"],
        why: "Everything but gunpowder. All five shaped daily life in Sumer." },
      { kind: "multi", prompt: "What can a stamped brick tell archaeologists?",
        options: ["The type of building", "The name of the city", "Which god was worshiped", "Who was king", "How many people lived there"],
        answers: ["The type of building", "The name of the city", "Which god was worshiped", "Who was king"],
        why: "Ur-Nammu's brick named his lady Inanna, himself as king of Ur, and the temple he built." },
      { kind: "multi", prompt: "Which were true of Mesopotamian women?",
        options: ["Those born of royalty could learn to read and write", "Some held administrative positions", "They conducted business", "They owned property", "They were forbidden to wear jewelry"],
        answers: ["Those born of royalty could learn to read and write", "Some held administrative positions", "They conducted business", "They owned property"],
        why: "Both men and women wore jewelry \u2014 bracelets, necklaces, and earrings." },
      { kind: "multi", prompt: "What did scribes keep records for?",
        options: ["Merchants", "The temple", "The government", "The army only"],
        answers: ["Merchants", "The temple", "The government"],
        why: "From those careful records we have learned much about Sumerian life." },
      { kind: "multi", prompt: "Which numbers or measures did the Mesopotamian base-60 system give us?",
        options: ["The 60-minute hour", "The 60-second minute", "The 360-degree circle", "The 100-year century"],
        answers: ["The 60-minute hour", "The 60-second minute", "The 360-degree circle"],
        why: "They also used geometry to measure fields and build temples." },
      /* --- true, or fix the underlined word (her study guide's format) --- */
      { kind: "correct", prompt: "Music was unimportant to religious rituals and daily work.",
        underlined: "unimportant", answer: false, correction: "important",
        options: ["important", "forbidden", "rare", "optional"],
        why: "Page 40: music WAS important to religious rituals and daily work. People sang to the gods and to the kings." },
      { kind: "correct", prompt: "Utnapishtim tells how he built a ship and gathered aboard his family in the Epic of Gilgamesh.",
        underlined: "Gilgamesh", answer: true, correction: null, options: [],
        why: "He also gathered the craftsmen who helped him and the animals of the field." },
      { kind: "correct", prompt: "The historically accurate account of the Flood was revealed to Moses by God.",
        underlined: "Moses", answer: true, correction: null, options: [],
        why: "God ensured the Flood was recorded accurately in Genesis 6\u20138, which Moses wrote." },
      { kind: "correct", prompt: "Mesopotamians made beautiful things with the stone they had.",
        underlined: "stone", answer: false, correction: "materials",
        options: ["materials", "gold", "clay", "bricks"],
      ...
      { kind: "correct", prompt: "Buildings were constructed of wood.",
        underlined: "wood", answer: false, correction: "bricks made of mud",
        options: ["bricks made of mud", "stone blocks", "reeds", "limestone"],
        why: "Page 41: wood was in short supply and stone was not available, so they built with mud bricks." },
      { kind: "correct", prompt: "Mesopotamians developed the arch and column.",
        underlined: "column", answer: true, correction: null, options: [],
        why: "They were also some of the first people to use domes. Found in temples and wealthy homes." },
      { kind: "correct", prompt: "If an enemy attacked, everyone moved inside the turrets.",
        underlined: "turrets", answer: false, correction: "walls",
        options: ["walls", "temples", "palaces", "gates"],
      ...
      { kind: "correct", prompt: "Houses varied according to the social status of the owner.",
        underlined: "social status", answer: true, correction: null, options: [],
      ...
      { kind: "correct", prompt: "Men wore skirt-like garments or robes pinned at the left shoulder.",
        underlined: "left", answer: false, correction: "right",
        options: ["right", "left", "either", "both"],
        why: "Page 44: MEN pinned at the right shoulder, WOMEN at the left. Easy to flip \u2014 worth memorizing." },
      { kind: "correct", prompt: "Parents in Sumer taught their children obedience and respect.",
        underlined: "obedience and respect", answer: true, correction: null, options: [],
        why: "They believed in strong discipline. A child who disobeyed might be disowned or sold into slavery." },

      /* --- later empires, pages 46 to 54 --- */
      { kind: "tf", prompt: "Sargon I established the world's first empire.",
        answer: true, why: "Around 2270 BC he came to power in the city-state of Kish, built Akkad as his capital, and united the city-states." },
      { kind: "tf", prompt: "Hammurabi created all the laws in his famous code himself.",
        answer: false, why: "He did NOT create them. He gathered, organized, and simplified laws that already existed \u2014 282 of them." },
      { kind: "tf", prompt: "The Assyrians created the largest empire the world had seen up to that point.",
        answer: true, why: "By around 750 BC it included the Fertile Crescent, Egypt, and part of Asia Minor." },
      { kind: "tf", prompt: "Under Hammurabi's Code, everyone received the same penalty for the same crime.",
        answer: false, why: "The penalty varied by the social class of the offender. A wealthy man who broke a commoner's bone only paid a fine." },
      { kind: "tf", prompt: "The Hittites excelled at producing iron and made the strongest weapons of their time.",
        answer: true, why: "The Assyrians later learned iron weapon-making from them." },
      { kind: "tf", prompt: "The Chaldean Empire lasted more than three hundred years.",
        answer: false, why: "It did not last even one hundred years. Under Belshazzar the Medes and Persians conquered the Chaldeans." },
      { kind: "mc", prompt: "A group of warriors standing close together in a square was called a ___.",
        options: ["phalanx", "cavalry", "province", "citadel"],
        answer: "phalanx",
        why: "Sumerian soldiers wore copper helmets and carried rectangular shields." },
      { kind: "mc", prompt: "Sargon I made ___ the capital of his empire.",
        options: ["Akkad", "Kish", "Babylon", "Nineveh"],
        answer: "Akkad",
        why: "He came to power in Kish, then built Akkad as his capital." },
      { kind: "mc", prompt: "Ur is mentioned in Genesis 11:31 as the birthplace of ___.",
        options: ["Abraham", "Noah", "Nimrod", "Moses"],
        answer: "Abraham",
        why: "God revealed Himself to Abraham around 2100 BC and called him to leave Ur \u2014 and a whole way of life." },
      { kind: "mc", prompt: "The Amorites established the Babylonian Empire with its capital at ___.",
        options: ["Babylon", "Akkad", "Nineveh", "Ur"],
        answer: "Babylon",
        why: "On the Euphrates River near modern-day Baghdad, Iraq." },
      { kind: "mc", prompt: "The Tower of Babel was probably built in or near ___.",
        options: ["Babylon", "Nineveh", "Ur", "Kish"],
        answer: "Babylon",
        why: "Nimrod, the great-grandson of Noah, established a kingdom that included Babylon (Gen. 10:10)." },
      { kind: "mc", prompt: "Hammurabi had his code engraved on ___ placed throughout the kingdom.",
        options: ["stone pillars", "clay tablets", "city gates", "temple walls"],
        answer: "stone pillars",
        why: "So that everyone would know the law." },
      { kind: "mc", prompt: "The Hittites were descendants of Heth, the grandson of ___.",
        options: ["Ham", "Shem", "Japheth", "Noah"],
        answer: "Ham",
        why: "Heth was the grandson of Ham and great-grandson of Noah (Gen. 10:15)." },
      { kind: "mc", prompt: "The peninsula between the Black Sea and the Mediterranean, now Turkey, is ___.",
        options: ["Asia Minor", "the Fertile Crescent", "Mesopotamia", "Media"],
        answer: "Asia Minor",
        why: "The Hittites began settling there about 2000 BC." },
      { kind: "mc", prompt: "The capital of the Assyrian Empire, built earlier by Nimrod, was ___.",
        options: ["Nineveh", "Babylon", "Akkad", "Ur"],
        answer: "Nineveh",
        why: "One of the first libraries was there. God sent Jonah to Nineveh to preach repentance." },
      { kind: "mc", prompt: "In 612 BC, who destroyed Nineveh and ended the Assyrian Empire?",
        options: ["The Chaldeans and Medes", "The Hittites", "The Amorites", "The Persians"],
      ...
      { kind: "mc", prompt: "The Hanging Gardens of Babylon were probably built by Nebuchadnezzar for ___.",
        options: ["his wife", "his father", "the god Merodach", "Daniel"],
        answer: "his wife",
        why: "She missed the plants of her mountain homeland. The gardens were one of the wonders of the ancient world." },
      { kind: "mc", prompt: "BC stands for \"before Christ\" and is written ___ the year.",
        options: ["after", "before", "above", "either way"],
        answer: "after",
        why: "AD stands for anno Domini, \"in the year of the Lord,\" and goes BEFORE the year." },
      { kind: "mc", prompt: "Circa, abbreviated ca. or c., is Latin for ___.",
        options: ["around", "before", "after", "century"],
        answer: "around",
        why: "It goes before a date when the exact year is not known with certainty." },
      { kind: "mc", prompt: "Modern-day ___ contains much of what was ancient Mesopotamia.",
        options: ["Iraq", "Iran", "Turkey", "Syria"],
        answer: "Iraq",
        why: "It sits in the Middle East at the head of the Persian Gulf." },
      { kind: "multi", prompt: "Which did the Akkadians borrow from the Sumerians?",
        options: ["Cuneiform writing", "Farming techniques", "Religion", "Iron weapons"],
        answers: ["Cuneiform writing", "Farming techniques", "Religion"],
        why: "Iron came later, from the Hittites." },
      { kind: "multi", prompt: "Which were true of the Assyrian military?",
        options: ["Foot soldiers", "Spearmen", "Archers", "A cavalry", "War chariots"],
        answers: ["Foot soldiers", "Spearmen", "Archers", "A cavalry", "War chariots"],
        why: "All five. They also tunneled under city walls and used battering rams on gates." },
      { kind: "multi", prompt: "How is Hammurabi's Code DIFFERENT from the Mosaic law?",
        options: ["The Mosaic law has large sections on how to worship God", "The Mosaic law forbids special treatment for the wealthy", "The Mosaic law is God-centered", "Hammurabi's Code was longer"],
        answers: ["The Mosaic law has large sections on how to worship God", "The Mosaic law forbids special treatment for the wealthy", "The Mosaic law is God-centered"],
